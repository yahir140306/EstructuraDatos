...
public class GestionPrincipal {
    private static List<Burbuja_Estudiante> listaEstudiantes = new ArrayList<>();

    public static void main(String[] args) {
        listaEstudiantes.add(new Burbuja_Estudiante("ABC001", "Juanchis", 9));
        listaEstudiantes.add(new Burbuja_Estudiante("ABC002", "Paco", 8.5));
        listaEstudiantes.add(new Burbuja_Estudiante("ABC003", "Panchito", 7));
        ...
        do {
            ...
            switch (opcion) {
                case "1":
                    ...
                    listaEstudiantes.add(new Burbuja_Estudiante(matricula, nombre, cal));
                ...
                case "2":
                    ...
                    Burbuja_Estudiante encontrado = buscarPorMatricula(matriculaConsulta);
                ...
                case "3":
                    ...
                    Burbuja_Estudiante aActualizar = buscarPorMatricula(matriculaActualizar);
                ...
                case "4":
                    ...
                    Burbuja_Estudiante aElminar = buscarPorMatricula(matriculaDelet);
                ...
                case "5":
                    ...
                    for (Burbuja_Estudiante estudiante : listaEstudiantes) {
    ...
    private static Burbuja_Estudiante buscarPorMatricula(String matricula) {
        for (Burbuja_Estudiante estudiante : listaEstudiantes) {
